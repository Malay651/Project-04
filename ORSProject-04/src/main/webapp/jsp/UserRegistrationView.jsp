		...
		<div align="center">
			...
			<table>
				...
				<tr>
					...
					<td><input type="date" name="dob" placeholder="Select Date of Birth"
				...
				<tr>
					<th></th>
					<td align="left" colspan="2"><input type="submit" name="operation" value="<%=UserRegistrationCtl.OP_SIGN_UP%>">&nbsp;
